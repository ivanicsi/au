...
Sterilizáló : `r inf %>% str_subset("\\sSTERILIZALO") %>% str_split("[ ]{2,}") %>% .[[1]] %>% .[2]`  
PROGRAM KEZD.IDO : `r inf %>% str_subset("\\sPROGRAM KEZD.IDO") %>% str_split("[ ]{2,}") %>% .[[1]] %>% .[2]`  
PROGRAM : `r inf %>% str_subset("\\sPROGRAM") %>% str_split("[ ]{2,}") %>% .[[1]] %>% .[2]`  
Ciklus : `r inf[2]`  
TERMEK KOD : __`r inf %>% str_subset("\\sTERMEK KOD") %>% str_split("[ ]{2,}") %>% .[[1]] %>% .[2]`__  
SARZSSZAM : `r inf %>% str_subset("\\sSARZSSZAM") %>% str_split("[ ]{2,}") %>% .[[1]] %>% .[2]`  
ID.STERILIZALO : `r inf %>% str_subset("\\sID.STERILIZALO") %>% str_split("[ ]{2,}") %>% .[[1]] %>% .[2]`  
